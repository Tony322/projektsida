...
<html>
  <head>
    ...
    <title>Speldalen - Xbox - Battlefront</title>
    <style type="text/css">
body {
    ...
    <div id="container">
        ...
        <main>
          <article class="product">
			...
			<img src="../../bilder/xbox/grandtheft.jpg" alt="Grand Theft Auto"/>
			<ul>
		  ...
		  <p> Ett prisbelönt actionspel om det moderna gangsterlivet,
		  där vapen, pengar, fordon och jobb spelar en stor rol!</p>
