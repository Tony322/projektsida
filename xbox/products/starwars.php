...
<html>
  <head>
    ...
    <title>Speldalen - Xbox - Starwars Battlefront</title>
    <style type="text/css">
body {
    ...
    <div id="container">
        ...
        <main>
          <article class="product">
			<h2>Starwars Battlefront</h2>
			<img src="../../bilder/xbox/starwars.jpg" alt="Starwars Battlefront"/>
			<ul>
		  ...
		  <p>Panga och skjut i rymden med dina vänner!<br>
		  Extra kul på en lördag med Starwars på tvn i bakgrunden!</p>
