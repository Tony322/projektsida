...
<html>
  <head>
    ...
    <title>Speldalen - Xbox - Minecraft</title>
    <style type="text/css">
body {
    ...
    <div id="container">
        ...
        <main>
          <article class="product">
			<h2>Minecraft</h2>
			<img src="../../bilder/xbox/minecraft.jpg" alt="minecraft"/>
			<ul>
				<li>Genere: Single / MMORPG</li>
		  ...
		  <p>Enormt MMORPG spel med många äventyr. <br>
		  Låter dig skapa din egen fantasivärld.</p>
