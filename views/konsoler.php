                ...
                <article>
                    ...
                    <table class="konsollisttable">
                        <tr>
                            <td>
                                <p>Nintendo Wii/U</p>
                                <a href="index.php?products/category/nintendo"><img src="bilder/nintendo.jpg" alt="Nintendo konsol"/></a>
                            </td>
                            <td>
                                <p>Microsoft Xbox</p>
                                <a href="index.php?products/category/xbox"><img src="bilder/xbox.jpg" alt="Xbox konsol"/></a>
                            </td>
                            <td>
                                <p>Sony Playstation</p>
                                <a href="index.php?products/category/playstation"><img src="bilder/ps4.jpg" alt="Playstation konsol"/></a>
                            </td>
                        </tr>
                    </table>
                </article>
